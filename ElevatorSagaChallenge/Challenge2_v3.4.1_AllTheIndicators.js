...
{ 
	//Version 3.4.1 Current Leading Edge of dev
   ...
   // going to go first and the elevator wrongly stops at that floor again. 
    init: function(elevators, floors) 
    {
    	...
    	{
    		var elevatorMaxPassengerCount = elevators[elevatorNum].maxPassengerCount();
    		if (elevatorMaxPassengerCount == 4)
    			return 0.5;
    		else if (elevatorMaxPassengerCount == 5)
    			return 0.55; 
    		else if (elevatorMaxPassengerCount == 6)
    			return 0.6;
    		else if (elevatorMaxPassengerCount == 8)
    			return 0.62;
    		else if (elevatorMaxPassengerCount == 10)
    			return 0.65;
    	}
